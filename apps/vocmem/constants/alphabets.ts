...
export const cyrillicToRomanConverter = {
  ...
  romans: ["A", "B", "V", "G", "D", "E", "Ë", "Zh", "Z", "I", "Ĭ", "K", "L", "M", "N", "O", "P", "R", "S", "T", "U", "F", "Kh", "Ts", "Ch", "Sh", "Shch", "ʺ", "ȳ", "ʹ", "é", "Yu", "Ya", "a", "b", "v", "g", "d", "e", "ë", "zh", "z", "i", "ĭ", "k", "l", "m", "n", "o", "p", "r", "s", "t", "u", "f", "kh", "ts", "ch", "sh", "shch", "ʺ", "ȳ", "ʹ", "é", "yu", "ya"]
}
