...
export const writingData: WritingData[] = [
  ...
  {
    orig: "妻は朝の散歩を日課にしています.",
    en: ["My wife walks every morning.", "My wife enjoys morning walks."],
    comment: []
  },
  {
  ...
  , {
    orig: "我々は円安に対策を講じなければなりません",
    en: ["We need to take measures against the yen’s depreciation."],
    comment: []
  }
  , {
  ...
  , {
    orig: "彼をあなたの誕生日会に呼びたい? あなた次第よ.",
    en: ["Do you want to invite him to your birthday party? It's up to you."],
    comment: []
  }
  , { orig: "いま向かっている途中だよ.", en: ["I'm on the way."], comment: [] }
];
