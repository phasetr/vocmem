...
{"title":"オイラー・ラグランジュ方程式","expression":"\\begin{aligned}\\frac{d}{dt} \\frac{\\partial L}{\\partial \\dot{q}_k} - \\frac{\\partial L}{\\partial q_k} = 0.\\end{aligned}","commentary":"最小作用の原理にしたがう経路がみたす微分方程式."}]}
